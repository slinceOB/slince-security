...
public class DefaultImageCodeGenerator implements ValidateCodeGenerator {
	...
	public ValidateCode generate(ServletWebRequest request) {
		...
		return createImage(width, height, codeCount, lineCount);
	}
	
	/**
	 * 生成图片
	 */
	private ImageCode createImage(int width, int height, int codeCount, int lineCount) {
         ...
         ImageCode imageCode = new ImageCode(buffImg, str1, securityProperties.getCode().getImage().getExpireIn());
